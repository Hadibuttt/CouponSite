<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from psdconverthtml.com/live/yourcoupon/coupon-v1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Mar 2022 16:59:45 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- SITE META -->
    <title>YourCoupon | @yield('title')</title>
                        ...
                        <div class="navbar navbar-default" role="navigation">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown hasmenu userpanel">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="thumbnails/{{Auth::user()->image}}" alt="" class="img-circle"> <span class="fa fa-angle-down"></span></a>
                                    <ul class="dropdown-menu start-right" role="menu">
                                        <li><a href="/user-dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                                        ...
                                        <li><a href="/coupon-submit"><i class="fa fa-bullhorn"></i> Submit Coupon</a></li>
...
<!-- Mirrored from psdconverthtml.com/live/yourcoupon/coupon-v1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Mar 2022 17:00:28 GMT -->
</html>